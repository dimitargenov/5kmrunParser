use fivekmrun;
SET @row_number = 0;
SELECT a.RunnerId, b.BestTime, a.Name, b.Best-- , b.RaceName 
FROM Results a
INNER JOIN 
(
	SELECT 
    MAX(AgePercent) AS Best, MIN(Time) AS BestTime,
		Results.RunnerId -- Time, Results.Position, 
        -- Runner.Name, 
    ...
    WHERE true
    AND Race.DomParkId = 1 -- by dom park
...
GROUP BY a.RunnerId, a.Name, b.BestTime, b.Best
ORDER BY b.Best ASC
LIMIT 100
